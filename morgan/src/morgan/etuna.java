...
public class etuna {
	...
	public static void main(String[] args) {
		  ...
		  String regNO="C026-01-0954/2022";
		  String StudentsName="Morgan Etuna";
		   System.out.print(invoiceDetails[0]+":"+regNO);
		   System.out.println("\t\t\t\t"+invoiceDetails[1]+":28/04/2020");
		   System.out.print(invoiceDetails[2]+":"+StudentsName);
		   ...
		   double[] cash={80.0,500.00,270.00,800.00};
		   System.out.println(cash[0]);
		   System.out.println("-------------------------------------------------------------------------------------");
		       System.out.println(quantity[1]+"\t|\tDuster\t\t\t|\t50\t\t|"+cash[1]);
		   System.out.println("-------------------------------------------------------------------------------------");
		       System.out.println(quantity[2]+"\t|\tPens\t\t\t|\t30\t\t|"+cash[2]);
		   System.out.println("-------------------------------------------------------------------------------------");
		       System.out.println(quantity[3]+"\t|\tcrayon\t\t\t|\t80\t\t|"+cash[3]);
		   System.out.println("=====================================================================================");
		  double totalsum=cash[0]+cash[1]+cash[2]+cash[3];
